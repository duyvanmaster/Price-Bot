      ...
      .addComponents(
        new StringSelectMenuBuilder()
          ...
          .addOptions([
            ...
            {
              label: 'Panel',
              description: 'Nhấn vào đây để xem bảng giá Panel',
              value: 'panelprice',
              emoji:'1066226154727542805'
            },
          ]),
      );
...
client.on('interactionCreate', async interaction => {
  ...
  // Panel select menu
    else if (interaction.values == 'panelprice') {
    const newRow = new ActionRowBuilder()
    .addComponents(
      new StringSelectMenuBuilder()
        .setCustomId('panel_select_menu')
        .setPlaceholder('Chi tiết về sản phẩm')
        .addOptions([
          {
            label: 'Panel Aimbot',
          ...
          {
            label: 'Panel Sniper H4X',
            value: 'sniph4x',
            emoji: '1066226154727542805'
          },
          {
            label: 'Panel Legit Safe',
            value: 'legitsafe',
            emoji: '1066226154727542805'
          },
          {
            label: 'Panel Custom FPS',
            value: 'cusfps',
            emoji: '1066226154727542805'
          },
        ])
    ...
    //Panel options
    else if(interaction.values == "panelaim") {
      interaction.reply({embeds: 
        [
          new EmbedBuilder()
    ...
    else if(interaction.values == "aimump") {
      interaction.reply({embeds: 
        [
          new EmbedBuilder()
    ...
    else if(interaction.values == "bypass") {
      interaction.reply({content:"**Panel Bypass is comming soon...**",
      ephemeral : true})
    }
    else if(interaction.values == "sniph4x") {
      interaction.reply({embeds: 
        [
          new EmbedBuilder()
    ...
    else if(interaction.values == "legitsafe") {
      interaction.reply({content:"**Legit Safe is comming soon...**" , ephemeral : true})
    }
    else if(interaction.values == "cusfps") {
      interaction.reply({embeds: 
        [
          new EmbedBuilder()
